...
assert(home.includes('data-professional-flow-band="deep"'), "Professional flow band should use the deep band treatment");
assert((home.match(/data-professional-flow-card/g) ?? []).length === 4, "Professional flow should render four glass cards");
assert((home.match(/data-professional-flow-icon/g) ?? []).length === 4, "Professional flow should render four bordered icon containers");
